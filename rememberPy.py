...
randPd = int( random.random() * 3 + 7)
#print len(sys.argv)
if(len(sys.argv) >= 3 and sys.argv[1] == 'search'):
    if(sys.argv[2] in CLASSES[7]):
        print 7
    elif(sys.argv[2] in CLASSES[8]):
        print 8
    elif(sys.argv[2] in CLASSES[9]):
        print 9
    else:
        print 'not found'
else:
    print CLASSES[randPd][int(random.random() * len(CLASSES[randPd]))]
